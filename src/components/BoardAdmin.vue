  ...
  <div class="container main-modification">
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="container departement-modification">
              ...
              <div class="show-search-list" id="liste_departement">
                <ul>
                  <li
                    ...
                    :key="departement.dep"
                    :id="departement.dep"
                    v-on:click="showUpdateDepartement(departement)"
                  >
                    {{ departement.nomDep }}
                  </li>
                </ul>
          ...
          <div class="row btn-add-departement">
            <button
              class="btn btn-primary btn-add-departement"
              v-on:click="showAddDepartement"
            >
              Add departement
            </button>
          </div>
        ...
        <div class="container lieu-modification">
              ...
              <div class="show-search-list" id="liste_lieux">
                <ul>
                  <li
                    ...
                    :key="lieu.codeInsee"
                    v-on:click="showUpdateLieu(lieu)"
                  >
          ...
          <div class="row btn-add-lieu">
            <button
              class="btn btn-primary btn-add-lieu"
              v-on:click="showAddLieu"
            >
              Add lieu
            </button>
          </div>
        ...
        <div class="container monument-modification">
          ...
          <div class="row container">
            <div class="form-group">
              <input
                ...
                class="form-control"
                id="monument"
                v-model="searchQueryMonuments"
                placeholder="Saisiez un monument ..."
              />
              <div class="show-search-list" id="liste_monuments">
                <ul>
                  <li
                    v-for="monument in resultQueryMonuments"
                    :key="monument.codeM"
                    v-on:click="showUpdateMonument(monument)"
                  >
                    {{ monument.nomM }}
                  </li>
                </ul>
          ...
          <div class="row btn-add-monument">
            <button
              class="btn btn-primary btn-add-monument"
              v-on:click="showAddMonument"
            >
              Add monument
            </button>
          </div>
        ...
        <div class="container celebrite-modification">
          ...
          <div class="row container">
            <div class="form-group">
              <input
                ...
                class="form-control"
                id="celebrite"
                v-model="searchQueryCelebrites"
                placeholder="Saisiez un celebrite ..."
              />
              <div class="show-search-list" id="liste_celebrites">
                <ul>
                  <li
                    v-for="celebrite in resultQueryCelebrites"
                    :key="celebrite.nom"
                    v-on:click="showUpdateCelebrite(celebrite)"
                  >
          ...
          <div class="row btn-add-celebrite">
            <button
              class="btn btn-primary btn-add-celebrite"
              v-on:click="showAddCelebrite()"
            >
              Add celebrite
            </button>
          </div>
      ...
      <div class="col-lg-6 col-md-6">
        ...
        <div
          class="container-fluid form-edit-departement"
          v-if="isShowModDepartement || isShowNewDepartement"
        >
          <h4 class="title-form-departement">
            Modification or Create new Departement
          </h4>
          <form>
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="col col-chef-lieu">
                <input
                  v-if="departement.chefLieu"
                  type="text"
                  class="form-control"
                  v-model="departement.chefLieu.codeInsee"
            ...
            <button
              type="button"
              v-if="isShowModDepartement"
              class="btn-primary btn-update-departement"
              v-on:click="updateDepartement()"
            >
              Update
            </button>
            <button
              type="button"
              v-if="isShowNewDepartement"
              class="btn-primary btn-create-departement"
              v-on:click="createNewDepartement()"
            >
              Create
            </button>
            <button
              type="button"
              v-if="isShowModDepartement"
              class="btn-danger btn-delete-departement"
              v-on:click="deleteDepartement()"
            >
              Delete
            </button>
          </form>
        ...
        <!--Form for Lieu-->
        <div
          class="container-fluid form-edit-lieu"
          v-if="isShowModLieu || isShowNewLieu"
        >
          <h4 class="title-form-departement">
            Modification or Create new Lieu
          </h4>
          <form>
            <div class="form-row">
            ...
            <button
              type="button"
              v-if="isShowModLieu"
              class="btn-primary btn-update-lieu"
              v-on:click="updateLieu()"
            >
              Update
            </button>
            <button
              type="button"
              v-if="isShowNewLieu"
              class="btn-primary btn-create-lieu"
              v-on:click="createNewLieu()"
            >
              Create
            </button>
            <button
              type="button"
              v-if="isShowModLieu"
              class="btn-danger btn-delete-lieu"
              v-on:click="deleteLieu()"
            >
              Delete
            </button>
          </form>
        ...
        <!--Form for Monument-->
        <div
          class="container-fluid form-edit-monument"
          v-if="isShowModMonument || isShowNewMonument"
        >
          <h4 class="title-form-departement">
            Modification or Create new Monument
          </h4>
          <form>
            <div class="form-row">
              <div class="col col-code-monument">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="monument-code-monument"
                  v-model="monument.codeM"
                  placeholder="Code Monument"
                />
              </div>
              <div class="col col-monument-lieu">
                ...
                <input
                  ...
                  class="form-control"
                  id="monument-lieu"
                  v-model="monument.lieu.codeInsee"
            ...
            <div class="form-row">
              <div class="col col-nom-monument">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="monument-nom-monument"
                  v-model="monument.nomM"
            ...
            <div class="form-row">
              <div class="col col-monument-proprietaire">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="monument-proprietaire"
                  v-model="monument.proprietaire"
              ...
              <div class="col col-monument-type-monument">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="monument-monument-type"
                  v-model="monument.typeMonument"
                  placeholder="Type Monument"
                />
              </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="col col-monument-list-celebrite">
                <label for="monument-celebrite"
                  >Celebrites in this Monument:</label
                >
                <ul id="monument-celebrite" v-if="monument.celebrities">
                  <li
                    v-for="celebriteD in monument.celebrities"
                    :key="celebriteD"
                  >
                    {{ celebriteD.nom }} {{ celebriteD.prenom }}
                    <button
                      type="button"
                      v-on:click="removeCelebriteFromMonument(celebriteD)"
                    >
                      X
                    </button>
                  </li>
            ...
            <div class="form-row">
              <label for="all-celebrites">All Celebrites:</label>
              <input
                type="text"
                class="form-control"
                id="all-celebrites"
                ...
                placeholder="Saisiez un celebrite ..."
              />
              <div class="show-search-list" id="liste_all_celebrites">
                <ul>
                  <li
                    v-for="celebrite in resultQueryCelebrites"
                    :key="celebrite.nom"
                  >
                    ...
                    <button
                      type="button"
                      v-on:click="addCelebriteToMonument(celebrite)"
                    >
                      +
                    </button>
                  </li>
            ...
            <div class="form-row">
              <div class="col-10 col-monument-photo-url">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="monument-photo-url"
                  v-model="monument.photoUrl"
            ...
            <div class="form-row">
              <div class="col-9 col-monument-choose-upload">
                <input
                  ...
                  accepte="image/*"
                  id="monument-upload-photo"
                  placeholder="Choose photo to upload"
                />
                <button type="button" @click="startUpload(this.typeM)">
                  Start Upload
                </button>
              </div>
            </div>
            ...
            <button
              type="button"
              v-if="isShowModMonument"
              class="btn-primary btn-update-monument"
              v-on:click="updateMonument()"
            >
              Update
            </button>
            <button
              type="button"
              v-if="isShowNewMonument"
              class="btn-primary btn-create-monument"
              v-on:click="createNewMonument()"
            >
              Create
            </button>
            <button
              type="button"
              v-if="isShowModMonument"
              class="btn-danger btn-delete-monument"
              v-on:click="deleteMonument()"
            >
              Delete
            </button>
          </form>
        ...
        <!--Form for Celebrite-->
        <div
          class="container-fluid form-edit-celebrite"
          v-if="isShowModCelebrite || isShowNewCelebrite"
        >
          <h4 class="title-form-departement">
            Modification or Create new Celebirite
          </h4>
          <form>
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="col col-celebrite-num-celebite">
                ...
                <input
                  ...
                  class="form-control"
                  id="celebrite-num"
                  v-model="celebrite.numCelebrite"
                  placeholder="Num Célébrite"
                  readonly="readonly"
                />
              </div>
              <div class="col col-celebrite-nationalite">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="celebrite-nationalite"
                  v-model="celebrite.nationalite"
            ...
            <div class="form-row">
              <div class="col col-celebrite-choose-upload">
                <input
                  ...
                  @change="onPhotoUpload()"
                  accepte="image/*"
                  id="celebrite-upload-photo"
                  placeholder="Choose photo to upload"
                />
                <button type="button" @click="startUpload(this.typeC)">
                  Start Upload
                </button>
              </div>
            </div>
            ...
            <button
              type="button"
              v-if="isShowModCelebrite"
              class="btn-primary btn-update-celebrite"
              v-on:click="updateCelebrite()"
            >
              Update
            </button>
            <button
              type="button"
              v-if="isShowNewCelebrite"
              class="btn-primary btn-create-celebrite"
              v-on:click="createNewCelebrite()"
            >
              Create
            </button>
            <button
              type="button"
              v-if="isShowModCelebrite"
              class="btn-danger btn-delete-celebrite"
              v-on:click="deleteCelebrite()"
            >
              Delete
            </button>
          </form>
...
export default {
  ...
  computed: {
    resultQueryDepartement() {
      $("#departement").change($("#liste_departement").fadeIn());
      if (this.searchQueryDeptements) {
        return this.departements.filter((departement) => {
          return this.searchQueryDeptements
            .toLowerCase()
            .split(" ")
    ...
    resultQueryLieux() {
      $("#lieu").change($("#liste_lieux").fadeIn());
    ...
    resultQueryMonuments() {
      $("#monument").change($("#liste_monuments").fadeIn());
      if (this.searchQueryMonuments) {
        return this.monuments.filter((monument) => {
          return this.searchQueryMonuments
            .toLowerCase()
            .split(" ")
    ...
    resultQueryCelebrites() {
      $("#celebrite").change($("#liste_celebrites").fadeIn());
      if (this.searchQueryCelebrites) {
        return this.celebrites.filter((celebrite) => {
          return this.searchQueryCelebrites
            .toLowerCase()
            .split(" ")
            .every((v) => celebrite.nom.toLowerCase().includes(v));
        });
      } else {
        return null;
      }
  ...
  methods: {
    ...
    updateDepartement() {
      DepartementService.editDepartement(
        this.departement.dep,
        this.departement.chefLieu.codeInsee
      );
    },
    deleteDepartement() {
    ...
    addCelebriteToMonument(celebrite) {
      MonumentService.addCelebriteToMonument(
        this.monument.codeM,
        celebrite.numCelebrite
      );
    },
    removeCelebriteFromMonument(celebriteD) {
      MonumentService.deleteCelebriteFromMonument(
        this.monument.codeM,
        celebriteD.numCelebrite
      );
    },
    ...
    updateCelebrite() {
      CelebriteService.editCelebrite(
        this.celebrite.numCelebrite,
        this.celebrite
      );
    },
    deleteCelebrite() {
